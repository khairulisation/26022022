...
def index():
    if request.method == "POST":
        ...
        s1 = "The score of credit card based on Decision Tree Model is: " + str(pred1)
        #Linear Regression Tree Model 
        model2 = joblib.load("CCU_Reg")
        pred2 = model2.predict([[purchases,suppcard]])
        s2 = "The score of credit card based on Linear Regression is: " + str(pred2)
        #Neural Network Model
        model3 = joblib.load("CCU_NN")
        pred3 = model3.predict([[purchases,suppcard]])
        s3 = "The score of credit card based on Neural Network is: " + str(pred3)
        #Random Forest Model
        model4 = joblib.load("CCU_RF")
        pred4 = model4.predict([[purchases,suppcard]])
        s4 = "The score of credit card based on Random Forest Model is:  " + str(pred4)
        #Gradient Boosting Model
        model5 = joblib.load("CCU_GB")
        pred5 = model5.predict([[purchases,suppcard]])
        s5 = "The score of credit card based on Gradient Boosting is: " + str(pred5)
